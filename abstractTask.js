...
AbstractTask.NETWORK_TYPE_UNMETERED = jobModule.UNMETERED;
AbstractTask.NETWORK_TYPE_NONE = jobModule.NONE;
AbstractTask.NETWORK_TYPE_ANY = jobModule.ANY;
...
AbstractTask.prototype = {
  ...
  getNetworkPrefrence: function() {
    return (this.taskDetails && this.taskDetails.networkNeeded) ? this.taskDetails.networkNeeded : AbstractTask.NETWORK_TYPE_ANY;
  },
  ...
  onScheduleComplete: function(status) {
    alert(status)
  },
